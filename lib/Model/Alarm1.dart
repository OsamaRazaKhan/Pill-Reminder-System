...
import 'package:pill_reminder_system/Screens/emergencyalert.dart';
...
class Alarm{
  ...
  String? dayName,time;
  Widget w1;
  Alarm(this.navigatorKey,this.patient_id,this.caretaker_id,this.w1);
  ...
  //   }
    if(is_snooze==false)
    {
      ...
      scheduledTime = tz.TZDateTime.from(DateTime.now().add(Duration(seconds: 1)), tz.local);
    }
    ...
    final Future<dynamic> Function(String?)? selectNotificationCallback =
      ...
      navigatorKey.currentState!.pushReplacement(
        MaterialPageRoute(builder: (context) {
          return EmergencyAlertPage(patient_id,caretaker_id,w1); // Replace with your custom alarm screen
        }),
      );
