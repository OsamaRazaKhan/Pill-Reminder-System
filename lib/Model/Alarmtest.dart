...
import 'package:pill_reminder_system/Screens/alarmcanceledscreen.dart';
...
class Alarm3{
  ...
  String? dayName,time;
  Widget w1;
  Alarm3(this.navigatorKey,this.patient_id,this.caretaker_id,this.w1);
  ...
  print('Alarm canceled');
    ...
    Future<void> scheduleAlarm() async {
      fnplugin2 = flutterLocalNotificationsPlugin;
      var scheduledTime;
  ...
  //   }
    if(is_snooze==false)
    {
      ...
      scheduledTime = tz.TZDateTime.from(DateTime.now().add(Duration(seconds: 5)), tz.local);
    }
    ...
    final Future<dynamic> Function(String?)? selectNotificationCallback =
      ...
      navigatorKey.currentState!.pushReplacement(
        MaterialPageRoute(builder: (context) {
          return CanceledAlertPage(patient_id, caretaker_id, w1); // Replace with your custom alarm screen
        }),
      );
