...
// class DispenserPage22 extends StatefulWidget {
...
//   DispenserPage22.Cons1(this.patient_id,this.w1,this.day,this.time,this.navigatorKey,this.med_chk);
//   @override
//   State<DispenserPage22> createState() => _DispenserPage22State.Cons1(patient_id,w1,day,time,navigatorKey,med_chk);
// }


// class _DispenserPage22State extends State<DispenserPage22> {
//   final GlobalKey<NavigatorState> navigatorKey;
//     String day,time;
//     bool med_chk;
//     Widget w1;
...
//     late int dosage;
//     int patient_id;
//     _DispenserPage22State.Cons1(this.patient_id,this.w1,this.day,this.time,this.navigatorKey,this.med_chk);
